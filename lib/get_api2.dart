...
Uri uri = Uri.parse('http://apis.data.go.kr/B552584/ArpltnInforInqireSvc/getCtprvnRltmMesureDnsty?sidoName=서울&pageNo=1&numOfRows=100&returnType=json&serviceKey=${_ApiKey2}&ver=1.1');
...
List<AirQuality> parseAirQuality(String responseBody) {
  ...
  final parsed = json.decode(responseBody)['item'].cast<Map<String, dynamic>>();
